...
function blueprint_load_css() {
	...
	$css_filetime = filemtime( get_template_directory() . '/assets/css/blueprint.css' );

	wp_enqueue_style( 'fontawesome', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css' );
    wp_enqueue_style( 'bb-blueprint', get_template_directory_uri() . '/assets/css/blueprint.css' , array(), $css_filetime, 'all' );
}
